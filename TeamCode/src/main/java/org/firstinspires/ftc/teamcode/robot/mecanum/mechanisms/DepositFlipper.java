...
public class DepositFlipper {
    public static double LEFT_GRABBING = 0.26;
    public static double RIGHT_GRABBING = 0.2;

    public static double LEFT_INTAKING = 0.37;
    public static double RIGHT_INTAKING = 0.32;
